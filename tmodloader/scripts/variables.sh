...
VAR_ARRAY[MODPACKx]="modpack=/opt/terraria/config/ModPacks/${MODPACK}/Mods/enabled.json"
VAR_ARRAY[MODPATHx]="modpath=/opt/terraria/config/ModPacks/${MODPACK}/Mods/"
...
if [ ! -e "/opt/terraria/config/ModPacks/${MODPACK}/Mods/enabled.json" ]; then
